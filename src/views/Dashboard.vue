...
<template>
    <div class="grid" v-bind:class="(layoutConfig.rtlActive.value) ? 'rtl' : 'lrt'">
        <div class="col-12 lg:col-6 xl:col-3" style="direction: ltr;">
            <div class="card mb-0">
        ...
        <div class="col-12 xl:col-6" style="direction: ltr;">
            <div class="card">
                <h5>Recent Sales</h5>
