...
const { changeThemeSettings, changeRtl, setScale, layoutConfig } = useLayout();
...
<template>
    <button class="layout-config-button p-link" v-bind:class="(layoutConfig.rtlActive.value) ? 'layout-config-button-rtl' : 'layout-config-button'"  type="button" @click="onConfigButtonClick()">
        <i class="pi pi-cog"></i>
    </button>
